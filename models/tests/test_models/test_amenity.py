...
class TestAmenity(unittest.TestCase):
    """
    class that tests the Amenity class which inherits from BaseModel
    """

    def setUp(self):
        """
        It is executed first before any other tests
        """
        try:
            os.remove("file.json")
        except IOError:
    ...
    def tearDown(self):
        """
        It is executed last after all tests have been performed
        """
        try:
            os.remove("file.json")
        except IOError:
    ...
    def test_init(self):
        """
        Tests whether the class is instantiated and inherits correctly
        """
        amenity = Amenity()
    ...
    def test_attributes(self):
        """
        Tests whether main class Attributes exist
        """
        amenity = Amenity()
        self.assertIsInstance(amenity, Amenity)
